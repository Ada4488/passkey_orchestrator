...
// Use fake timers for controlling setTimeout, setInterval, etc.
vi.useFakeTimers();

// Setup window with secure context before anything else
const mockWindow = {
...
// Mock window for secure context (this overrides happy-dom's window)
...
// Also ensure the globals are set properly for tests
