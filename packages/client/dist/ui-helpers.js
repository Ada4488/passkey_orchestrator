 ...
 */
import { PasskeyRegistrationFailedError, PasskeyAuthFailedError, PasskeyConfigurationError, PasskeyEnvironmentError } from '@passkey-orchestrator/shared';
/**
 * Get user-friendly prompt information based on environment and operation
 */
function getPromptInfo(operation, environment) {
 ...
 */
export function renderPasskeyPrompt(operation, environment, config = {}) {
  ...
  `;
    ...
    if (config.showCancel) {
        const cancelButton = modal.querySelector('.passkey-prompt-cancel');
 ...
 */
export function hidePasskeyPrompt(element) {
 ...
 */
export function showPasskeyError(error, config = {}) {
  ...
  `;
    // Add event listeners
    const closeButton = container.querySelector('.passkey-error-close');
    closeButton.addEventListener('click', () => {
        hidePasskeyError(container);
        config.onDismiss?.();
    });
    if (config.showRetry) {
        const retryButton = container.querySelector('.passkey-error-retry');
 ...
 */
export function hidePasskeyError(element) {
 ...
 */
function getPasskeyPromptStyles() {
    return `
 ...
 */
function getPasskeyErrorStyles() {
    return `
